...
export const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center px-4 relative py-12">
      ...
      <div className="w-full max-w-lg bg-bg2/90 border border-primary/15 rounded-3xl p-8 shadow-glass backdrop-blur-lg transform hover:-translate-y-1 transition-all duration-300 relative z-10">
        ...
        <div className="flex bg-bg rounded-2xl p-1.5 border border-primary/10 mb-8">
          <button 
            ...
            className={`flex-1 text-center py-2.5 font-bold rounded-xl text-sm transition-all ${
              activeTab === 'login' ? 'bg-primary text-white shadow-glow' : 'text-textSecondary hover:text-textPrimary'
            }`}
          >
            Sign In
          </button>
          <button 
            ...
            className={`flex-1 text-center py-2.5 font-bold rounded-xl text-sm transition-all ${
              activeTab === 'register' ? 'bg-primary text-white shadow-glow' : 'text-textSecondary hover:text-textPrimary'
            }`}
          >
            Create Account
          </button>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button 
            ...
            className="w-full flex items-center justify-center bg-gradient-to-r from-primary to-primary-light text-white font-bold py-3 px-4 rounded-2xl shadow-glow hover:opacity-95 transition-opacity disabled:opacity-50"
          >
            {isSubmitting ? (
