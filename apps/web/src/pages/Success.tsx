...
export const Success: React.FC = () => {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4 relative py-12">
      ...
      <div className="w-full max-w-md bg-bg2 border border-primary/20 rounded-3xl p-8 text-center shadow-glass backdrop-blur-lg animate-fade-in relative z-10 space-y-6">
