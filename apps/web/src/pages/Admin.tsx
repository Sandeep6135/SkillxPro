...
export const Admin: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-6">
      ...
      {/* Admin header */}
      <div className="bg-bg2 border border-emerald-500/25 rounded-3xl p-6 shadow-glass flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
      ...
      {activeAdminTab === 'overview' && (
        <div className="space-y-6 animate-fade-in">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-bg2 border border-primary/10 rounded-2xl p-6 flex items-center justify-between shadow-glass">
              <div>
      ...
      {activeAdminTab === 'users' && (
        <div className="bg-bg2 border border-primary/15 rounded-3xl p-6 shadow-glass space-y-4 animate-fade-in">
